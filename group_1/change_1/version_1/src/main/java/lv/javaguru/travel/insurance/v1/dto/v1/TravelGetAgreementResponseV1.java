...
import lv.javaguru.travel.insurance.v1.dto.CoreResponse;
import lv.javaguru.travel.insurance.v1.dto.RiskPremium;
import lv.javaguru.travel.insurance.v1.dto.ValidationError;
import lv.javaguru.travel.insurance.v1.dto.util.BigDecimalSerializer;
...
@NoArgsConstructor
@AllArgsConstructor
public class TravelGetAgreementResponseV1 extends CoreResponse {
    ...
    public TravelGetAgreementResponseV1(List<ValidationError> errors) {
        super(errors);
    }
